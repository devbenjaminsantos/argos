...
- [x] Preparar checkpoint curto da resposta Telegram: consulta antes da coleta e gravação depois, ambas revalidando lease/payload; replay igual reutiliza snapshot e resposta divergente falha. Oito integrações PostgreSQL aguardam CI.
