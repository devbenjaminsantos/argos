...
**Próximo item:** V2.9 — Preparar seleção de remoção pelo mapa UUID
...
- [ ] Preparar seleção pelo mapa UUID e confirmação vinculada à proposta antes da integração pública.
