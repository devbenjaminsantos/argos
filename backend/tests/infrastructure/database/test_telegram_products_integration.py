...
def context():
    ...
    lease = uuid4()
    cleanup = "TRUNCATE product_price_observations, monitored_products, telegram_registration_results, telegram_update_inbox, telegram_conversation_drafts, telegram_users"
