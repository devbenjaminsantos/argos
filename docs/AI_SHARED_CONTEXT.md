...
- Histórico de 17/09: `/verificar` implantado em `c830c6c`, banco em `20260916_10`, tentativas sem preço. Reprodução encontrou HTTP 403. `d829a10` classifica 403/429 e falhas de abertura; 596 testes locais e CI `35232666792` registrados. Em 19/09, o Render foi conferido no deploy live `dep-dalvuadbedkc73a4m4jg`, commit `6404b50`, que contém a correção, sem erros recentes. Falta confirmar a mensagem de bloqueio por uma nova interação real antes de declarar o diagnóstico aceito.
