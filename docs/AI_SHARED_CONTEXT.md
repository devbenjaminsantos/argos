...
1. Preparar o recebimento e a validação da URL do Mercado Livre no rascunho: definir o contrato antes de admitir texto livre, preservar escopo por proprietário, expiração e versão, e persistir avanço e resposta atomicamente por update/lease. Não coletar a página nem concluir o produto neste próximo incremento.
