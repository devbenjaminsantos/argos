...
- ACLs padrão do provedor para `public` não são tratadas como isolamento; antes de criar novas tabelas, sequências ou funções, os grants herdados devem ser revisados e o DML do runtime deve ser explícito;
