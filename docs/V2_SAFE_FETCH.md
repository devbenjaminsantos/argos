...
TLS real validado localmente com certificado efêmero e socketpair: hostname/SNI original aceito e hostname divergente recusado. Leitura HTTP bloqueada interrompida pelo prazo total; 35 testes relacionados passaram. Sem Internet; destino TCP simulado, handshake criptográfico real. Próximo incremento: redirecionamentos com nova validação de URL/DNS/IP por salto e deadline compartilhado. Não integrado ao bot; V2.10 permanece aberta.
